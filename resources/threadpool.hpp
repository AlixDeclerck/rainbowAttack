...
class ThreadPool //FIXME : I suspect I'm vulnerable to race / spurious wakeups
{
    ...
    public:
         ...
         * @param n the number of worker threads to generate
         ...
         * @param args the arguments of the function to generate
         * @tparam Function the type of the function to generate
         * @tparam Args the type of the arguments of the function to generate
         */
